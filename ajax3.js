/*Exatamente o mesmo exemplo do ajax2, utilizando a biblioteca axios
existente em "https://github.com/axios/axios"*/ 
function buscar() {
    /*
    function myPromise() {
    ...
    */
    ...
    axios.get('https://api.github.com/users/orlando-gomes')
